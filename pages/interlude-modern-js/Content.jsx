...
const START_LOADING = Symbol();
const SET_DATA = Symbol();
const SET_ERROR = Symbol();

const startLoading = () => ({type: START_LOADING});
const setData = (data) => ({type: SET_DATA, data});
const setError = (error) => ({type: SET_ERROR, error});

const reducer = (state = {loading: false, error: null, data: null}, action) => {
    switch (action.type) {
        case START_LOADING:
            return {
                loading: true,
          ...
          <br/>
            ...
            { data && (
                <>
                    ...
                    <br/>
                    <p>
                        Total Incomplete Points: {calculateIncompletePoints(data)}
                    </p>
                </>
            )}
        </>
